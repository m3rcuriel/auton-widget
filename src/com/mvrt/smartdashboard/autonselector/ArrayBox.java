...
public class ArrayBox extends StaticWidget {
	...
	public void init() {
		...
		save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Robot.getTable("AUTONOMOUS").putValue("Auton Array", values);
			}
		});
		...
		load.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				InputStream is = this.getClass().getClassLoader().getResourceAsStream("presets.txt");
	...
	private class NewPresetLoadDialog extends JDialog {
		...
		public NewPresetLoadDialog(InputStream is) {
			...
			String[] listarr = presets.keySet().toArray(new String[presets.size()]);
